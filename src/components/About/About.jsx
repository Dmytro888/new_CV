...
import Avatar from '../../img/003375.jpg';
        ...
        <section className={styles.mainInfo}>
          ...
          <ul>
            <li className={styles.skillsItem}>
              ...
              <p>
                HTML5 / CSS3 / Javascript ES6+ / ReactJS / Redux / React Hooks /
                Sass/ Rest API / NodeJS / WebPack / Npm / Express / MongoDB / UI
                libraries
              </p>
            </li>
            <li className={styles.skillsItem}>
            ...
            <li className={styles.skillsItem}>
              <h4 className={styles.skillsType}>Learning: </h4>
              <p>ReactNative / TypeScript / NextJS</p>
            </li>
          </ul>
        </section>
        <section className={styles.mainInfo}>
